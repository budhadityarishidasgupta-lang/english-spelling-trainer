...
if SPELLING_ADMIN_VNEXT:
    ...
    with tab_lessons:
        ...
        if df_courses.empty:
            ...
            df_lessons = list_lessons(course_id)
            if df_lessons.empty:
    ...
    # -----------------------------
    with tab_progress:
        df_progress = list_student_progress()
...
if SPELLING_ADMIN_VNEXT:
    ...
    # IMPORTANT:
    # These imports MUST live inside this block
    from spelling_app.repository.admin_console_vnext_repo import (
        list_courses,
        list_lessons,
        list_students,
